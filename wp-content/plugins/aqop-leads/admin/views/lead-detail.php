				...
				<table class="form-table">
					<tbody>
						...
						<tr>
							...
							<td>
								<a href="https://wa.me/<?php echo esc_attr( preg_replace( '/[^0-9]/', '', $lead->whatsapp ) ); ?>" target="_blank" rel="noopener">
					...
					<tbody>
						<tr>
							...
							<td>
								...
								?>
								<span class="aqop-priority-badge" style="background-color: <?php echo esc_attr( $priority_color ); ?>; color: white; padding: 4px 12px; border-radius: 12px; font-size: 12px; font-weight: 600; text-transform: uppercase;">
						...
						<tr>
							...
							<td>
								...
								<span class="dashicons dashicons-yes-alt" style="color: #48bb78;" title="<?php esc_attr_e( 'Synced', 'aqop-leads' ); ?>"></span>
							</td>
						</tr>
						<?php endif; ?>
					</tbody>
			...
			<div class="card">
				...
				<div class="aqop-notes-section">
					...
					<div class="aqop-add-note">
						<form method="post" action="<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>" class="aqop-note-form">
							...
							<?php foreach ( $notes as $note ) : ?>
								...
								<div class="aqop-note-item" data-note-id="<?php echo esc_attr( $note->id ); ?>">
									...
									<div class="aqop-note-content">
										...
										<div class="aqop-note-text" data-original-text="<?php echo esc_attr( $note->note_text ); ?>">
											<?php echo wp_kses_post( nl2br( esc_html( $note->note_text ) ) ); ?>
										</div>
										<div class="aqop-note-edit-form" style="display: none;">
											<textarea class="aqop-note-edit-textarea" rows="3"><?php echo esc_textarea( $note->note_text ); ?></textarea>
			...
			<div class="card">
				...
				<table class="widefat striped">
					...
					<tbody>
						...
						<tr>
							<td><strong><?php echo esc_html( ucwords( str_replace( '_', ' ', $field_key ) ) ); ?></strong></td>
							<td>
								<?php
		...
		<div class="aqop-lead-sidebar">
			...
			<div class="card">
				...
				<div class="aqop-actions-list">
					<a href="<?php echo esc_url( $edit_url ); ?>" class="button button-secondary button-large" style="width: 100%; margin-bottom: 8px;">
						<span class="dashicons dashicons-edit"></span>
						<?php esc_html_e( 'Edit Lead', 'aqop-leads' ); ?>
					</a>
					...
					<button 
						type="button" 
						class="button button-secondary button-large aqop-sync-airtable" 
					...
					<button 
						type="button"
						class="button button-link-delete button-large aqop-delete-trigger"
						style="width: 100%;"
					>
						<span class="dashicons dashicons-trash"></span>
	...
	<div id="delete-lead-modal" class="aqop-modal" style="display: none;">
		<div class="aqop-modal-content">
			<div class="aqop-modal-header">
				...
				<button type="button" class="aqop-modal-close" aria-label="<?php esc_attr_e( 'Close', 'aqop-leads' ); ?>">&times;</button>
			</div>
			<div class="aqop-modal-body">
				...
				<p><?php esc_html_e( 'This action cannot be undone. All associated notes will also be deleted.', 'aqop-leads' ); ?></p>
